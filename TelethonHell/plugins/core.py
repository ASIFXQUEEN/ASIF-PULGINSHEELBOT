...
CmdHelp("core").add_command(
    ...
    "uninstall", "<plugin name>", "Uninstalls the given plugin from 𝐒ᴛʀᴀɴɢᴇʀ. To get that again do .restart", "uninstall alive"
).add_command(
    ...
    "repo", None, "Gives 𝐒ᴛʀᴀɴɢᴇʀ's Github repo link."
).add_command(
