...
async def _(event):
    ...
    animation_chars = [
        "**Heroku Connecting To Latest [Github Build](ASHIF903)**",
        ...
        "__INFO:𝐌𝐈𝐒𝐒𝐐𝐔𝐄𝐄𝐍 𝐁𝐎𝐓:Logged in as 557667062__",
        "__INFO:𝐌𝐈𝐒𝐒𝐐𝐔𝐄𝐄𝐍 𝐁𝐎𝐓:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
